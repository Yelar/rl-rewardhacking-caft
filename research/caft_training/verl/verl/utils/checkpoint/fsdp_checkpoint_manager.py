    ...
    def load_checkpoint(self, local_path: str, hdfs_path: str = None, del_local_after_load=False):
        ...
        with get_fsdp_state_ctx(self.model, StateDictType.SHARDED_STATE_DICT, state_dict_cfg, optim_cfg):
            ...
            if self.should_load_optimizer:
                ...
                if getattr(self, "caft_restore_optimizer_replica_layout", False):
                    from src.train.verl.caft_checkpoint import restore_optimizer_replica_layout
                    optimizer_state_dict = restore_optimizer_replica_layout(self.optimizer, optimizer_state_dict)
